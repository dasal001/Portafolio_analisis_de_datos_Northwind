...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'b85fbf97-47c4-11f1-a206-2cf05de95394:1-124614';
...
CREATE TABLE `employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`),
  CONSTRAINT `fk_employee_privileges_privileges` FOREIGN KEY (`privilege_id`) REFERENCES `privileges` (`id`)
...
CREATE TABLE `inventory_transactions` (
  ...
  CONSTRAINT `fk_inventory_transactions_inventory_transaction_types` FOREIGN KEY (`transaction_type`) REFERENCES `inventory_transaction_types` (`id`),
  CONSTRAINT `fk_inventory_transactions_orders` FOREIGN KEY (`customer_order_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `fk_inventory_transactions_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `fk_inventory_transactions_purchase_orders` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders` (`id`)
...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `fk_order_details_order_details_status` FOREIGN KEY (`status_id`) REFERENCES `order_details_status` (`id`),
...
CREATE TABLE `purchase_order_details` (
  ...
  KEY `purchase_order_id` (`purchase_order_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `fk_purchase_order_details_inventory_transactions` FOREIGN KEY (`inventory_id`) REFERENCES `inventory_transactions` (`id`),
...
CREATE TABLE `purchase_orders` (
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status` FOREIGN KEY (`status_id`) REFERENCES `purchase_order_status` (`id`),
...
-- Dump completed on 2026-07-06 12:01:42
